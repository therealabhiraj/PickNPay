...
//   return (
//     <footer className="bg-white dark:bg-gray-900" style={{ marginTop: 'auto' }}>
...
//               </li>
//               <li className="mb-4">
//                 <Link to="/brand-center" className="hover:underline">Brand Center</Link>
//               </li>
//               <li className="mb-4">
...
//             <ul className="text-gray-500 dark:text-gray-400 font-medium">
//               <li className="mb-4">
//                 <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="hover:underline">Discord Server</a>
//               </li>
//               <li className="mb-4">
...
//             © {currentYear} <a href="/" className="hover:underline">PickNPay™</a>. All Rights Reserved.
//           </span>
...
//   return (
//     // Added 'border-t border-gray-200' for the separating line
//     <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700" style={{ marginTop: 'auto' }}>
//       <div className="mx-auto w-full max-w-screen-xl">
//         <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
//           <div>
//             <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Company</h2>
...
//   return (
//     // Changed bg-white to bg-gray-100 and dark:bg-gray-900 to dark:bg-gray-950
//     <footer className="bg-gray-100 dark:bg-gray-950 border-t border-gray-200 dark:border-gray-700" style={{ marginTop: 'auto' }}>
//       <div className="mx-auto w-full max-w-screen-xl">
//         <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
//           <div>
//             <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Company</h2>
...
const ShoppingFooter = () => {
  ...
  return (
    // Main footer background: slightly adjusted dark mode to gray-900
    <footer className="bg-gray-100 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700" style={{ marginTop: 'auto' }}>
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Company</h2>
        ...
        {/* This is the bottom section for copyright and social media */}
        {/* Changed bg-gray-100 to bg-gray-200 and dark:bg-gray-700 to dark:bg-gray-950 */}
        <div className="px-4 py-6 bg-gray-200 dark:bg-gray-950 md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
            © {currentYear} <a href="/" className="hover:underline">PickNPay™</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
