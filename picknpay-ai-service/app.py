...
CORS(app, resources={r"/*": {"origins": ["http://localhost:5173", "http://localhost:5000", "https://your-netlify-domain.netlify.app"]}})

MONGO_URI = os.getenv("MONGO_DB_URL")
if not MONGO_URI:
    print("Error: MONO_DB_URL environment variable not set for Python service.")
